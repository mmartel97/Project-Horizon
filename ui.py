...
MEDIUMBIGFONT = pygame.font.Font('assets/fonts/roboto regular.ttf', 24)
BIGFONT = pygame.font.Font('assets/fonts/roboto regular.ttf', 30)
JUMBOFONT = pygame.font.Font('assets/fonts/roboto regular.ttf', 60)
